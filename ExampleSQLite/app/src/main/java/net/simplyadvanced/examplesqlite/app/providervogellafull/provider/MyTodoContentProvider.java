package net.simplyadvanced.examplesqlite.app.providervogellafull.provider;
...
import net.simplyadvanced.examplesqlite.app.providervogellafull.db.TodoDatabaseHelper;
